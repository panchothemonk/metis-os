...
fn english(id: MessageId) -> &'static str {
    match id {
        ...
        MessageId::CmdDreamDescription => "Run the dreaming extraction pipeline over past sessions",
...
fn japanese(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::CmdDreamDescription => "過去のセッションから dreaming 抽出パイプラインを実行",
...
fn chinese_simplified(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::CmdDreamDescription => "对过去的会话运行 dreaming 提取管道",
...
fn portuguese_brazil(id: MessageId) -> Option<&'static str> {
    Some(match id {
        ...
        MessageId::CmdDreamDescription => {
            "Executar o pipeline de extração dreaming sobre sessões passadas"
        }
