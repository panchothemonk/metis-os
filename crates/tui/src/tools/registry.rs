...
impl ToolRegistryBuilder {
    ...
    /// Add the `memory_user_edits` tool. Always included in the catalog;
    /// the tool itself handles the case where memory is not configured.
    #[must_use]
    pub fn with_memory_user_edits_tool(self) -> Self {
        use super::memory_user_edits::MemoryUserEditsTool;
